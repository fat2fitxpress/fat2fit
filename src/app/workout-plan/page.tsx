...
export const metadata: Metadata = {
    title: 'Workout Plans 2026 - Strength, HIIT, Zone Zero & Functional Training | Fat2Fit',
    description: 'Scientifically-designed workout plans for 2026: strength training, HIIT, Zone Zero training, snack-sized workouts, reverse running, and functional programs. Build longevity, prevent sarcopenia, and optimize metabolic health for busy professionals.',
    keywords: [
        'workout plans 2026',
        ...
        // Gentle & Functional Movement (2026 trending)
        'Zone Zero training',
    ...
    openGraph: {
        title: 'Workout Plans 2026 - Strength, HIIT, Zone Zero & Longevity | Fat2Fit',
        description: 'Professionally designed workout plans for fat loss, longevity, and peak fitness. Zone Zero training, snack-sized workouts, and science-backed programs.',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Fat2Fit Workout Plans - Strength, HIIT, Zone Zero 2026',
            },
        ],
    },
};
