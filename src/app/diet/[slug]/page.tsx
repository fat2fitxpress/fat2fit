...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: `Follow our detailed ${diet.title} program. Full day meal plan with ingredients and preparation steps.`,
        openGraph: {
            title: `${diet.title} | Fat2Fit`,
            description: `Detailed diet plan for ${diet.title}.`,
            type: 'website',
        },
    };
}
